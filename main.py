...
class Aerobus:
    def __init__(self, brand: str, weight: Union[int, float]):
        """
        Создание объекта Самолет
        :param brand: Модель самолета
        :param weight: Масса самолета
        :raise: TypeError: Если название модели самолета не принадлежить типу str
        :raise: TypeError: Если масса самолета не принадлежит типу int или float
        :raise: ValueError: Если масса самолета меньше нуля
        Пример:
        >>> air = Aerobus("Pobeda", 10)
        """
